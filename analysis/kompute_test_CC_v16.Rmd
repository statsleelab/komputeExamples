---
title: "Evaluating KOMPUTE - Clinical Chemistry data"
...
```{r comp_pheno_corr_gene_corr, fig.width=12, fig.height=2.7}
...
saveRDS(pheno.cor, file = "data/CC.pheno.cor.v16.rds")
